  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/eadmin/">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>eAdministraci&oacute;n</span></a>
      </li>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="/eadmin/portafirmas.jsp">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Portafirmas</span></a>
      </li>

      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="/eadmin/carpeta.jsp">
          <i class="fas fa-fw fa-table"></i>
          <span>Carpeta ciudadana</span></a>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">e-Administraci&oacute;n</h1>
